<div class="container">
    <article class="content-card">
        ...
        <div class="content navigable-headers">
            ...
            <h2 id="full-privacy-policy"> Full Privacy Policy </h2>
            
            <p>University of Newcastle Upon Tyne (<b>“Newcastle University”</b>, <b>“we”</b>, <b>“us”</b>), the owner of <b>Make Place</b>, an online geographical mapping tool (the <b>“Site”</b>, or <b>"Service"</b>), recognizes the importance of your privacy. Therefore, we have created this Privacy Policy so that you know how we use and disclose your information when you make it available to us. This Privacy Policy applies solely to information collected at this Site. By using or accessing the Site, you signify your agreement to be bound by our Privacy Policy.</p>
            
            <p><strong>IF YOU DO NOT AGREE TO THIS PRIVACY POLICY YOU MAY NOT ACCESS OR OTHERWISE USE OUR SITE.</strong></p>
            
            <h4 id="personal-information">Personal Information that we collect</h4>
            <p> We do not collect personal information from you unless you voluntarily provide it to us, such as when you sign up for the site, or add a pin to the map. </p>
            
            <h4 id="non-personal-information">Non-personal or Aggregate Information that we collect</h4>
            <p>We may collect non-personally identifiable information, such as pages viewed, browser type, duration and frequency of visits or other data, and may aggregate any information collected in a manner which does not identify any individual (“Aggregate Information”). Aggregate Information obtained in connection with the Site may be intermingled with and used by us in conjunction with information obtained through sources other than the Site, including both offline and online sources. Aggregate Information may be shared by us with third parties by allowing them to link to and collect data from the Site. This data will be used for their benefit and for ours, for marketing advertising or other purposes, including analysis of the Site for purposes of improving your experience with the Site and academic publication.</p>
            ...
            <h4 id="other-sites-and-applications">Other Sites and Applications</h4>
            <p>As a convenience to you, we may provide links to third-party sites from within our Site. We are not responsible for the privacy practices or content of any third parties or third-party sites. We encourage you to review these privacy policies to ensure that you are familiar with their terms.</p>
            ...
            <p>We reserve the right, at our discretion, to change, modify, add, or remove portions from this Privacy Policy at any time. Your continued use of the Site following the posting of any changes to this Privacy Policy means you accept and consent to such changes.</p>
            
            <h4 id="opt-out-process">Opt-Out Process</h4>
            <p>If you do not want to receive email communications (including email digests) from us in the future, please send an email to us at $ContactEmailLink requesting to be removed from our mailing list. You will also have the option of clicking on a link included in email correspondence you receive from us in order to remove yourself from our mailing list.</p>
            <p>If you do not want to want to receive our newsletters in the future, please send an email to us at $ContactEmailLink requesting to be removed from our mailing list. You will also have the option of clicking on a link included in the newsletters you receive from us in order to remove yourself from our mailing list.</p>
            ...
            <h4 id="communications-with-us">Communications with Us</h4>
            ...
            <p>Any communication or material you transmit to us by email or otherwise, including any data, questions, comments, suggestions, or the like is, and will be treated as, non confidential and nonproprietary. Furthermore, you expressly agree that we are free to use any ideas, concepts, know-how, or techniques contained in any communication you send to us without compensation and for any purpose whatsoever, including but not limited to, developing, manufacturing and marketing products and services using such information.</p>
            
            <h4 id="site-terms-of-use">Site Terms of Use</h4>
            <p>Use of this Site is governed by, and subject to, the Terms of Use contained at $TermsLink. This Privacy Policy is incorporated into such terms. Your use, or access, of the Site constitutes your agreement to be bound by these provisions.</p>
            
            <p><strong>IF YOU DO NOT AGREE TO THESE TERMS OF USE YOU MAY NOT ACCESS OR OTHERWISE USE THE SITE.</strong></p>
            
            <h4 id="transfers-outside-the-eea">Transfers of Personal Data Outside the EEA</h4>
